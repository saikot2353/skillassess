    ...
    <div className="space-y-6 pb-12 max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-xl p-4 border border-[#E8D9D2] shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative w-full md:w-80">
          ...
          <input
            type="text"
            placeholder={isRTL ? 'البحث بالاسم، الجواز أو APRO...' : 'Search by candidate, passport, APRO...'}
            value={searchQuery}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs bg-gray-50 p-4 rounded-xl">
              <div>
                ...
                <div className="text-[11px] text-gray-500 font-mono">{inspectCandidate.aproReference}</div>
              </div>
              <div>
